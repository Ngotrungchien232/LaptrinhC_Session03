...
int main() {
	...
	int abcd, hang_nghin, hang_tram, hang_chuc, hang_don_vi, dcba;
	...
	hang_don_vi = abcd % 10;
	// dao nguoc cac so 
	dcba = hang_don_vi * 1000 + hang_chuc * 100 + hang_tram * 10 + hang_nghin;
	// in ra man hinh
	printf("so dao nguoc cua ban la: %d", dcba);
	return 0;
}
